            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/admin/exit.jsp">exit</a></li>
						...
						<header class="codrops-header">
							<h1>Edit the data of disease<span>Hospital information management system</span></h1>
						</header>
						<div class="main clearfix">
						<form class="form-signin" action="/DiUpdate" onsubmit="check(this)" name="input" method="post">
...
<div id="st-trigger-effects" class="column">
                				...
                				<input type="text" id="deid" name="deid" value=<%=Integer.parseInt(request.getParameter("deid"))%> readonly=readonly class="form-control" placeholder="Please type in deid" required autofocus><br>
</div>
<div class="column">
                 				<label for="dename">DENAME</label>
                				<input type="text" id="dename" name="dename" value=<%=request.getParameter("dename")%> class="form-control" onkeyup="this.value=this.value.toUpperCase()" placeholder="Please type in dename" required><br>
