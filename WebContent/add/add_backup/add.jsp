				...
				<div class="st-content"><!-- this is the wrapper for the content -->
					<div class="st-content-inner"><!-- extra div for emulating position:fixed of the menu -->
						...
						<header class="codrops-header">
							<h1>添加人员信息 <span>Hospital information management system</span></h1>
						</header>
						<div class="main clearfix">
						<form class="form-signin" action="addperson.jsp" onsubmit="check(this)" name="input" method="post">
							<div id="st-trigger-effects" class="column">
                 				<label for="inputID">用户ID</label>
                				<input type="text" id="inputID" name="id" class="form-control" placeholder="请输入id" required autofocus><br>
							...
							<div class="column">
                				...
                				<input type="submit" class="btn btn-primary" id="btn-login" value="添加">&nbsp;&nbsp;&nbsp;
